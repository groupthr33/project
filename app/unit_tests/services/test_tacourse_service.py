...
class TestTaCourseService(TestCase):
    ...
    def test_assign_ta_happy_path(self):
        ...
        actual_response = self.tacourse_service.assign_ta(self.taName, self.course_id, self.section,
    ...
    def test_course_dne(self):
        ...
        actual_response = self.tacourse_service.assign_ta(self.taName, "CS666", self.section, self.remaining_sections)

        self.assertEqual(expected_response, actual_response)

    def test_course_section_dne(self):
        expected_response = "Section 002 dne."
        actual_response = self.tacourse_service.assign_ta(self.taName, self.course_id, "002", self.remaining_sections)

        self.assertEqual(expected_response, actual_response)

    def test_ta_dne(self):
        expected_response = "thebadta dne."
        actual_response = self.tacourse_service.assign_ta("thebadta", self.course_id, self.section,
                                                          self.remaining_sections)
